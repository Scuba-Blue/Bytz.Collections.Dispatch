...
/// <summary>
/// function list taking 8 parameters.
/// </summary>
...
: Dictionary<Func<T1, T2, T3, T4, T5, T6, T7, T8, bool>, Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>>, IFunctionDispatch
{
    ...
    {
        IEnumerable<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> actions = Where(p1, p2, p3, p4, p5, p6, p7, p8);
    ...
    /// <param name="p6">parameter 6</param>
    /// <param name="p7">parameter 7</param>
    /// <param name="p8">parameter 8</paramS>
