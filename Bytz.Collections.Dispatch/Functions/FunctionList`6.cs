...
/// <summary>
/// function list taking 5 generic parameter(s).
/// </summary>
...
public class FunctionList<T1, T2, T3, T4, T5, TReturn>
: Dictionary<Func<T1, T2, T3, T4, T5, bool>, Func<T1, T2, T3, T4, T5, TReturn>>
, IFunctionDispatch
{
    /// <summary>
    ...
    {
        return Single(p1, p2, p3, p4, p5)(p1, p2, p3, p4, p5);
    }
    ...
    /// <param name="p5">generic parameter 5</param>
    /// <returns></returns>
    public IEnumerable<Func<T1, T2, T3, T4, T5, TReturn>> Where
    (
        T1 p1,
        T2 p2,
        T3 p3,
