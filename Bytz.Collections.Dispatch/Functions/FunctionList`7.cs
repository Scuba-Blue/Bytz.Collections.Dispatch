...
/// <summary>
/// function list taking 6 generic parameter(s).
/// </summary>
...
: Dictionary<Func<T1, T2, T3, T4, T5, T6, bool>, Func<T1, T2, T3, T4, T5, T6, TReturn>>
, IFunctionDispatch
{
    /// <summary>
    ...
    {
        this.Where(p1, p2, p3, p4, p5, p6).ToList().ForEach(f => f(p1, p2, p3, p4, p5, p6));
    }
    ...
    {
        IEnumerable<Func<T1, T2, T3, T4, T5, T6, TReturn>> functions = Where(p1, p2, p3, p4, p5, p6);
        ...
        functions.ToList().ForEach(f => f(p1, p2, p3, p4, p5, p6));
    }
