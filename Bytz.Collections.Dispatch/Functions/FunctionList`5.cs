...
/// <summary>
/// function list taking 4 generic parameter(s).
/// </summary>
...
public class FunctionList<T1, T2, T3, T4, TReturn>
: Dictionary<Func<T1, T2, T3, T4, bool>, Func<T1, T2, T3, T4, TReturn>>
, IFunctionDispatch
{
    /// <summary>
    ...
    public Func<T1, T2, T3, T4, TReturn> Single
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    /// <returns>related element or null</returns>
    /// <exception cref="InvalidOperationException">if the same criteria for the key has been defined more than once.</exception>
    public Func<T1, T2, T3, T4, TReturn> SingleOrDefault
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    {
        return Single(p1, p2, p3, p4)(p1, p2, p3, p4);
    }
    ...
    (
        ...
        T3 p3,
        T4 p4,
        Func<T1, T2, T3, T4, TReturn> @default
    )
    {
        return (SingleOrDefault(p1, p2, p3, p4) ?? @default)(p1, p2, p3, p4);
    }
    ...
    {
        this.Where(p1, p2, p3, p4).ToList().ForEach(f => f(p1, p2, p3, p4));
    }

    /// <summary>
    /// find all actions that match the current state of the parameters.
    /// </summary>
    /// <param name="p1">generic parameter 1</param>
    /// <param name="p2">generic parameter 2</param>
    /// <param name="p3">generic parameter 3</param>
    /// <param name="p4">generic parameter 4</param>
    /// <returns></returns>
    public IEnumerable<Func<T1, T2, T3, T4, TReturn>> Where
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    {
        IEnumerable<Func<T1, T2, T3, T4, TReturn>> functions = Where(p1, p2, p3, p4);
        ...
        functions.ToList().ForEach(f => f(p1, p2, p3, p4));
    }
