...
/// <summary>
/// function list taking 3 generic parameter(s).
/// </summary>
...
: Dictionary<Func<T1, T2, T3, bool>, Func<T1, T2, T3, TReturn>>
, IFunctionDispatch
{
    /// <summary>
    ...
    /// <summary>
    /// find all functions that match the current state of the generic parameter(s).
    /// </summary>
    /// <param name="p1">generic parameter 1</param>
    /// <param name="p2">generic parameter 2</param>
    /// <param name="p3">generic parameter 3</param>
