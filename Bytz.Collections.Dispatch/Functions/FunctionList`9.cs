...
/// <summary>
/// function list taking 8 generic parameter(s).
/// </summary>
...
/// <typeparam name="T7">generic parameter 7</typeparam>
/// <typeparam name="T8">generic parameter 8</typeparam>
/// <typeparam name="TReturn">type of the return from the function</typeparam>
public class FunctionList<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>
: Dictionary<Func<T1, T2, T3, T4, T5, T6, T7, T8, bool>, Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>>
, IFunctionDispatch
{
    /// <summary>
    ...
    /// <param name="p7">generic parameter 7</param>
    /// <param name="p8">generic parameter 8</param>
    ...
    public Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> Single
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    /// <returns>related element or null</returns>
    /// <exception cref="InvalidOperationException">if the same criteria for the key has been defined more than once.</exception>
    public Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> SingleOrDefault
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    {
        return Single(p1, p2, p3, p4, p5, p6, p7, p8)(p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    (
        ...
        T7 p7,
        T8 p8,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> @default
    )
    {
        return (SingleOrDefault(p1, p2, p3, p4, p5, p6, p7, p8) ?? @default)(p1, p2, p3, p4, p5, p6, p7, p8);
    }
    ...
    {
        this.Where(p1, p2, p3, p4, p5, p6, p7, p8).ToList().ForEach(f => f(p1, p2, p3, p4, p5, p6, p7, p8));
    }
    ...
    /// <param name="p8">generic parameter 8</param>
    /// <returns></returns>
    public IEnumerable<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> Where
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    {
        IEnumerable<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> functions = Where(p1, p2, p3, p4, p5, p6, p7, p8);
        ...
        functions.ToList().ForEach(f => f(p1, p2, p3, p4, p5, p6, p7, p8));
    }
