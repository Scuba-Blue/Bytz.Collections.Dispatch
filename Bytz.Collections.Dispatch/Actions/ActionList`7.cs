...
/// <summary>
/// action list taking 7 generic parameter(s).
/// </summary>
...
public class ActionList<T1, T2, T3, T4, T5, T6, T7>
: Dictionary<Func<T1, T2, T3, T4, T5, T6, T7, bool>, Action<T1, T2, T3, T4, T5, T6, T7>>
, IActionDispatch
{
    /// <summary>
    ...
    public Action<T1, T2, T3, T4, T5, T6, T7> Single
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    /// <returns>related element or null</returns>
    /// <exception cref="InvalidOperationException">if the same criteria for the key has been defined more than once.</exception>
    public Action<T1, T2, T3, T4, T5, T6, T7> SingleOrDefault
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    /// <exception cref="InvalidOperationException">when the criteria produces no results for the input</exception>>
    public void Call
    (
        T1 p1,
        T2 p2,
    ...
    {
        Single(p1, p2, p3, p4, p5, p6, p7)(p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    (
        ...
        T6 p6,
        T7 p7,
        Action<T1, T2, T3, T4, T5, T6, T7> @default
    )
    {
        (SingleOrDefault(p1, p2, p3, p4, p5, p6, p7) ?? @default)(p1, p2, p3, p4, p5, p6, p7);
    }
    ...
    {
        this.Where(p1, p2, p3, p4, p5, p6, p7).ToList().ForEach(a => a(p1, p2, p3, p4, p5, p6, p7));
    }
    ...
    /// <param name="p7">generic parameter 7</param>
    /// <returns></returns>
    public IEnumerable<Action<T1, T2, T3, T4, T5, T6, T7>> Where
    (
        T1 p1,
        T2 p2,
        T3 p3,
    ...
    {
        IEnumerable<Action<T1, T2, T3, T4, T5, T6, T7>> actions = Where(p1, p2, p3, p4, p5, p6, p7);
        ...
        actions.ToList().ForEach(a => a(p1, p2, p3, p4, p5, p6, p7));
    }
